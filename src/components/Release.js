    ...
    <div className="releases">
      <div className="release orange">
        <div className="content">
          ...
          <p className="description">We have released four limited edition NFTs early which can be bid on via <a href="#features">OpenSea</a></p>
          <p className="description">There will be the only four of these NFTs we ever make, so be sure not to miss out!</p>
          <p className="description">50% of proceeds go to charity.</p>
          <a href="#features" className="link">Check them out <BsArrowRight /></a>
        </div>
        <div className="image">
